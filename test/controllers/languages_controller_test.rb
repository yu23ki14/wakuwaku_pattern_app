...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference('Language.count') do
      post languages_url, params: { language: { lg_code: @language.lg_code, lg_name: @language.lg_name } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { lg_code: @language.lg_code, lg_name: @language.lg_name } }
